...
//        this.password = "pivot";
    ...
    public String login() {
        if (getUsername().equals(getPassword())) {
            return "success";
        } else if (checkOracle(getUsername(),getPassword())){
    ...
    private boolean checkOracle(String username, String password) {
        return "scott".equals(username) && "tiger".equals(password);
    }
}
